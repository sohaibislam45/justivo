    ...
    return (
        <div className="bg-white border-b border-gray-100 py-3 hidden lg:block">
            <div className="container mx-auto px-6 flex justify-between items-center">
                <div className="flex items-center gap-8 text-[11px] uppercase tracking-[0.2em] font-medium text-secondary/60">
                ...
                <div className="flex items-center gap-10 text-[11px] uppercase tracking-[0.15em] font-medium text-secondary/70">
