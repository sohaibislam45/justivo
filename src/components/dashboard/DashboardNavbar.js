                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <div className="hidden md:block text-left">
                                <p className="text-xs font-bold text-secondary uppercase tracking-widest">John Doe</p>
                        ...
                        {showProfile && (
                            <div className="absolute top-full right-0 mt-4 w-48 bg-white shadow-xl border border-gray-100 py-3 rounded-sm">
                                ...
                                <button className="block w-full text-left px-6 py-2 text-sm text-red-500 hover:bg-[#FAF9F6]">Logout</button>
                            </div>
                        )}
                    </div>
                </div>
